...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const mapping: Record<string, string[]> = {
      ...
      city: ['도시', '시도', '시', 'city', '지역1'],
      district: ['시군구', '구군', '구', 'district', '지역2'],
      dong: ['동', '법정동', 'dong', '읍', '면', '지역3'],
      addr_parcel: ['지번주소', '주소(지번)', '주소_지번', 'addr_parcel'],
      addr_road: ['도로명주소', '주소(도로명)', '주소_도로명', 'addr_road', '도로명', '주소', '위치', '가동위치', '설치위치', '장소'],
      building_type: ['건물유형', '유형', 'building_type', '구분'],
      built_year: ['준공연도', '준공년도', 'built_year', '입주년도', '준공'],
      ...
      units: ['판매수량', '판매', 'units', '업소수', '가동수', '가동수량'],
      unit_price: ['대당단가', '단가', 'unit_price', '개별단가'],
      price_4w: ['4주금액', '4주 금액', 'price_4w', '단지총단가', '총단가'],
